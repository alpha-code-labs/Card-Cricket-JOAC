...
public class GameplayConfiguration : MonoBehaviour
{
    ...
    void InitializeConfigurations()
    {
        gameplayConfigs = new Dictionary<string, GameplayConfig>
        {
            ...
            // New gameplays (12-17)
            {"1990/03/05", new GameplayConfig(12, "1990/03/05", 15, 0, PitchCondition.Friendly)}, // Batting first
            {"1990/03/06", new GameplayConfig(13, "1990/03/06", 20, 40, PitchCondition.Friendly)}, // Chase 40 runs
            {"1990/03/07", new GameplayConfig(14, "1990/03/07", 15, 35, PitchCondition.Friendly)}, // Chase 35 runs
            {"1990/03/28", new GameplayConfig(15, "1990/03/28", 40, 0, PitchCondition.Friendly)}, // Batting first
            {"1990/03/29", new GameplayConfig(16, "1990/03/29", 50, 110, PitchCondition.Friendly)}, // Chase 110 runs
            {"1990/03/30", new GameplayConfig(17, "1990/03/30", 40, 100, PitchCondition.Friendly)} // Chase 100 runs
        };
    }
